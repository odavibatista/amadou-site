...
export default function AboutHero() {
    ...
    return(
        <section className={styles.section}>
            ...
            <p>
                {portuguese ? "Amadou costumava trabalhar colhendo madeira, porém as novas leis ecológicas do país o colocaram numa situação financeira pior, e desde então ele e sua família passaram a viver em condições precárias.": 
            ...
            <p>
                {portuguese ? "Não bastando isso, tempos depois dos ocorridos, Amadou teve a notícia de que um parente seu havia falecido, e desde então, teve que cuidar de mais duas crianças órfãs, que começaram a integrar sua família." : 
            ...
            <p>
                {portuguese ? "Amadou, vendo as dificuldades, utilizou o celular que possuía para solicitar doações pela internet para pessoas de outros países, e assim, conseguir ajudar sua família, pois a moeda local não é muito valorizada, e Amadou passou um tempo sem conseguir trabalho." : 
            ...
            <p>
                {portuguese ? "Algumas pessoas se compadeceram de Amadou e decidiram ajudá-lo doando dinheiro para ajudá-lo, e duas vaquinhas foram criadas para ajudar Amadou, uma delas foi criada por um brasileiro, e a outra por um europeu. Juntas, elas arrecadavam dinheiro para Amadou, e enviavam para ele quando podiam." : 
            ...
            <p>
                {portuguese ? "Amadou tentava ajudar sua família com o que tinha, mas quis tentar ajudar mais, e em outubro de 2023, Amadou decidiu pegar um barco para a Espanha, com o objetivo de conseguir cuidar da sua família indo para lá. Porém, o barco de Amadou desapareceu, e desde então, ele nunca mais foi visto." :
            ...
            <p>
                {portuguese ? "Este site foi criado para tentar divulgar a causa de Amadou e ajudar ele a alimentar sua família, porém ele infelizmente não está mais entre nós. O site ainda está no ar para que possamos lembrar de Amadou e de sua história, e para que outras pessoas possam ser ajudadas através deste domínio." :
            ...
            <p>
                {portuguese ? "Pedimos que vejam algumas das pessoas em necessidade que deixaremos na aba 'Ajudar'. Caso consigamos um meio de ajudar a família de Amadou, informaremos em outra atualização futura." : 
            ...
            <p>
                {portuguese ? "Obrigado por ler a história de Amadou." : "Thank you for reading Amadou's story."}
            </p>
        </section>
    )
}
